...
The project includes basic website components such as:

- Header
- Footer
- Navigation Bar
- Web pages
- Schema for Content Modules

You can edit the page by modifying the respective `page.tsx` file in the 'app' folder and subfolders. The page auto-updates as you edit the file.
...
- [Sanity Documentation](https://www.sanity.io/docs) - learn more about Sanity.
